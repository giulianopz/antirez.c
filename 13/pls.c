...
int main(void)
{
  ...
  // It could be heplful to add other 4 bytes in the string prefix to count its references.
  // That would make memory managment semi-automatic but it would be also cubersome to maintain.
  // A natural solution to this issue is to use a `struct` .
  return 0;
}
